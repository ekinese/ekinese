...
add_action( 'admin_menu', function () {
	...
	$groups = array(
		...
		'Financieel & Treuhand' => array( 'xg_escrow', 'xg_depot_item', 'xg-depot-fees', 'xg-pay', 'xg_invoice', 'xg-accounting', 'xg-btw' ),
		'B2B & HR'              => array( 'xg_partner', 'xg_employee', 'xg_timeentry' ),
		'Instellingen'          => array( 'xg-funnel', 'xg-roles', 'xg-marketing', 'xg-analytics', 'xg-spot', 'xg-legal', 'xg-smtp', 'xg-ai', 'xg-integrations', 'xg-perf', 'xg-login', 'xg-phone', 'xg-install' ),
	);
