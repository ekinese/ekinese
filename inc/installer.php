...
function ekinese_install_pages() {
	return array(
		...
		'treuhand'              => array( 'Treuhandservice', "<!-- wp:group {\"className\":\"xg-blueprint\"} -->\n<div class=\"wp-block-group xg-blueprint\"><!-- wp:ekinese/escrow /--></div>\n<!-- /wp:group -->", null ),
		'depot'                 => array( 'Virtueel Depot', "<!-- wp:group {\"className\":\"xg-blueprint\"} -->\n<div class=\"wp-block-group xg-blueprint\"><!-- wp:ekinese/depot /--></div>\n<!-- /wp:group -->", null ),
