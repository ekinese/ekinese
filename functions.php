...
require_once get_theme_file_path( 'inc/business-pro.php' );
...
require_once get_theme_file_path( 'inc/smtp.php' );
require_once get_theme_file_path( 'inc/payments.php' );
require_once get_theme_file_path( 'inc/verify.php' );
...
require_once get_theme_file_path( 'inc/google-news.php' );
...
require_once get_theme_file_path( 'inc/phone.php' );
